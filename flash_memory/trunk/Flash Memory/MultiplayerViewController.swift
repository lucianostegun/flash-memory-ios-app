...
class MultiplayerViewController: UIViewController, UIAlertViewDelegate {
    ...
    var gameLevelOpponent : GameLevel!;
    ...
    override func viewDidLoad() {
        ...
        multipeerDisplayName = appDelegate.multipeerDisplayName
        lblOpponentDeviceName.text = multipeerDisplayName;
        updateResumeInfo()
    }
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "MPCManagerDisconnectedFromPeer", name: "stopMultiplayerGame", object: nil);
    ...
    override func viewDidDisappear(animated: Bool) {
        ...
        NSNotificationCenter.defaultCenter().removeObserver(self, name: "MPCManagerDisconnectedFromPeer", object: nil);
    ...
    func updateResumeLabels(){
        ...
        lblCurrentScoreOpponent.text = String(format: "\(multipeerDisplayName) %07d", mainScoreOpponent);
    }
    ...
    func updateScoreBoard(){
        ...
        sendMessageToOtherPlayer("updateScore", message: gameLevel);
        updateResumeLabels()
    }
    ...
    func updateScoreBoardOpponent(){
        ...
        var gameLevel = gameLevelOpponent;
        var gameStage = gameLevel.getStage();
    ...
    func sendMessageToOtherPlayer(key: String, message: AnyObject) -> Bool {
        ...
        if( key != nil ){
            ...
            if( key == "message" ){
                ...
                if( message == "_end_game_" ){
                    ...
                    var alertView = UIAlertView(title: NSLocalizedString("Multiplayer closed", comment: ""), message: "\(multipeerDisplayName) "+NSLocalizedString("closed multiplayer session.", comment:""), delegate: self, cancelButtonTitle: NSLocalizedString("OK", comment: ""));
...
//                println("message: gamePath");
                ...
                gameLevelOpponent = dataDictionary["message"] as! GameLevel;
